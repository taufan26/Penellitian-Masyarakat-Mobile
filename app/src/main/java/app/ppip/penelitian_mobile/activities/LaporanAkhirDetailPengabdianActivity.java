...
public class LaporanAkhirDetailPengabdianActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        download = findViewById(R.id.laporan_akhir_pengabdian_download_btn);
        ...
        download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(LaporanAkhirDetailPengabdianActivity.this, "Mulai Downloading.", Toast.LENGTH_SHORT).show();
            }
        });
